...
// Merge Sort Memory Map
// Used between SimpleBus & MergeSort
const int MERGE_MM_BASE = 0x90000000;
const int MERGE_MM_SIZE = 0x0000000C;
const int MERGE_MM_MASK = 0x0000000F;
