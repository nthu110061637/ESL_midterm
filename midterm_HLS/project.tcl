...
#
# This is not synthesizable module
define_system_module	main	main.cc		;# SystemC module for simulation only, sc_main(top) drives everything
define_system_module	System	system.cc	;# SystemC module for simulation only, system.cc include dut and tb 
define_system_module	tb	tb.cc			;# SystemC module for simulation only

#
# Synthesis Module Configurations
#
# This is the synthesizable module
define_hls_module	dut	dut.cc		;# SystemC module to be synthesized
define_hls_config	dut	BASIC		;# A synthesis configuration of the hls_module but actually doing any option set up here
define_hls_config   dut DPA         --dpopt_auto=op,expr
#
# Simulation Configurations
#
define_sim_config B			{dut BEH}			;# A behavioral PIN-level configuration
# This is a SystemC-based simulation to make sure the design is correct.
# only do the simulation so it does not use any synthesis configuration

define_sim_config BASIC_V	{dut RTL_V BASIC}	;# RTL Verilog cosimulation
# we use systemC testbench(tb.cc) to generate cycle behavior for testbench but the circuit hase already been synthesized

define_sim_config DPA_V	{dut RTL_V DPA};
